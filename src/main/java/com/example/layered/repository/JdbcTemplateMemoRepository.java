...
public class JdbcTemplateMemoRepository implements MemoRepository {
    ...
    @Override
    public int updateMemoo(Long id, String title, String contents) {
    ...
    public int updateTitle(Long id, String title) {
        int updatedRow = jdbcTemplate.update("update memo set title = ? where id = ?", title, id);
    ...
    public int deleteMemo(Long id) {
        int updatedRow = jdbcTemplate.update("delete from memo where id = ?", id);
